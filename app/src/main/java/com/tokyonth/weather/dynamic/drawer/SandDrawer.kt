...
class SandDrawer(isNight: Boolean) : BaseDrawer<ArcHolder>(isNight) {

    companion object {
        private const val SAND_COUNT = 30
    }
    ...
    override fun makeSkyBackground(): Pair<IntArray, IntArray> {
        return Pair(SkyBackground.SAND_N, SkyBackground.SAND_D)
    }
